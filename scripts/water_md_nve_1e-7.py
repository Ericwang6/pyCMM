...
if __name__ == '__main__':
    ...
    system = ff.parametrize(top, use_fd_morse=True, use_polarization=True, polarization_tolerance=1e-7, use_hardness_change=False, use_lr_dispersion=True, cutoff_sr=9.0, use_switch=True, use_customized_ops=True)
