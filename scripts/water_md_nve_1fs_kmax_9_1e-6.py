...
if __name__ == '__main__':
    ...
    system = ff.parametrize(top, use_fd_morse=True, use_polarization=True, polarization_tolerance=1e-6, ewald_tolerance=1e-9, use_hardness_change=False, use_lr_dispersion=True, cutoff_sr=9.0, use_switch=True, use_customized_ops=True)
    ...
    traj = Trajectory('cmm_ewald_1fs_kmax_9_1e-6.traj', 'a', atoms)
    dyn.attach(traj.write, interval=1000)
    log = create_all_logger('cmm_ewald_1fs_kmax_9_1e-6.out', atoms, dyn)
