...
if __name__ == '__main__':
    ...
    system = ff.parametrize(top, use_fd_morse=True, use_polarization=True, polarization_tolerance=1e-5, ewald_tolerance=1e-9, use_hardness_change=False, use_lr_dispersion=True, cutoff_sr=9.0, use_switch=True, use_customized_ops=True)
    ...
    traj = Trajectory('water_md_nve_1ns_large_k_1e-5.traj', 'a', atoms)
    dyn.attach(traj.write, interval=1000)
    log = create_all_logger('water216_1ns_large_k_1e-5.log', atoms, dyn)
