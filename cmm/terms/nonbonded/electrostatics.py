...
class ElectrostaticEnergy2(Term):
    def __init__(self, alpha: float):
        self.alpha = alpha
        super().__init__()
    ...
    def param_data(self):
        return [
            ('q', ParameterType.Atomic, CutoffType.NB_Medium),
            ('dipo', ParameterType.Atomic, CutoffType.NB_Medium)
            ('quad', ParameterType.Atomic, CutoffType.NB_Medium)
        ]
